...
def test_pool_can_acquire_twice(pool):
    address = ("127.0.0.1", 7687)
    connection_1 = pool._acquire(address, 3, None)
    connection_2 = pool._acquire(address, 3, None)
...
def test_pool_can_acquire_two_addresses(pool):
    ...
    connection_1 = pool._acquire(address_1, 3, None)
    connection_2 = pool._acquire(address_2, 3, None)
