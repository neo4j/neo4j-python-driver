    ...
    [
        (
            ("127.0.0.1", 7687),
            {
                ...
                "port": 7687,
                "str": "127.0.0.1:7687",
                "repr": "IPv4Address(('127.0.0.1', 7687))",
            },
        ),
        (
            ("localhost", 7687),
            {
                ...
                "port": 7687,
                "str": "localhost:7687",
                "repr": "IPv4Address(('localhost', 7687))",
            },
        ),
        (
            (None, None),
        ...
        (
            (None, None, None, None),
            {
                ...
                "port": None,
                "str": "[None]:None",
                "repr": "IPv6Address((None, None, None, None))",
            },
        ),
        (
...
def test_address_initialization(
    test_input: tuple | Address, expected: dict
) -> None:
