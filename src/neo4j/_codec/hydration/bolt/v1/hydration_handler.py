...
class _GraphHydrator(GraphHydratorBolt):
...
class HydrationHandler(HydrationHandlerBoltBase):
    def __init__(self) -> None:
        super().__init__()
        self.struct_hydration_functions = {
            **self.struct_hydration_functions,
    ...
    def new_hydration_scope(self) -> HydrationScopeBolt:
        return HydrationScopeBolt(self, _GraphHydrator())
